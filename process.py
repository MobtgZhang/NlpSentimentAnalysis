...
def prepare_embedding(vocab_size,word_to_idx,idx_to_word):
    ...
    return weight
def prepare_train(train_features,train_labels,validate_features,validate_labels,weight,vocab_size,model_save_file,
...
def train_entry():
    ...
    # training the model
    train_loss_list,validate_loss_list = prepare_train(train_features,train_labels,validate_features,validate_labels,weight,vocab_size,config.model_save_file,
