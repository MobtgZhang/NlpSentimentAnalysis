...
train_file = os.path.join(home,"AI_Challenger2018","NewCode4","AI-Challenger2018","sentiment_analysis_trainingset.csv")
validation_file = os.path.join(home,"AI_Challenger2018","NewCode4","AI-Challenger2018","sentiment_analysis_validationset.csv")
test_file = os.path.join(home,"AI_Challenger2018","NewCode4","AI-Challenger2018","sentiment_analysis_testset.csv")
# Save data files
save_datafile = os.path.join(home,"AI_Challenger2018","NewCode4","data_processed")
...
cache_file = os.path.join(home,"AI_Challenger2018","NewCode4","tmp")
